...
urlpatterns = [
    ...
    path('dashboard-estudiante/historial-asistencia/', views.historial_asistencia, name='historial_asistencia'),
    path('dashboard-estudiante/actas-disponibles/', views.actas_disponibles, name='actas_disponibles'),
    ...
    path('reunion/<int:reunion_id>/registrar-asistencia/', views.registrar_asistencia, name='registrar_asistencia'),
